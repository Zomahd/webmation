package com.accenture.automation.web.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.accenture.automation.web.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.accenture.automation.web.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
